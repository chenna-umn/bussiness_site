...
<div class="container">
    <div class="row-fluid">
        <div class="col-sm-8">
            <center><h3 class="branch_title_color">Sri Krishna - Hyderabad</h3></center>
        </div>
        <div class="col-sm-4">
        ...
        <div class="col-sm-8">
            <div class="thumbnail">
                <div style="width: 99.9%;">
                   <?php include_once 'gal/loc_srikrishna.php'; ?>
                </div>
            </div>
        </div>
        <div class="col-sm-4 thumbnail">
            ...
            <div class="tabPad">
                    <p>
                        ...
                        Independent Bungalow situated in center of the city in posh location of 
                        Banjara Hills with a cozy home ambience and splendid facilities. 
                        Far from pollution and traffic but near to all the fun and happening places. 
                        You also get to enjoy the following hospitality services:
                        Room types available: Economy, Deluxe Rooms and Suite. <br><br>
                    </p>
                    <p> 
                    </p><address>
                        ...
                        Hyderabad, Andhra Pradesh 500034.<br>
                        Phone: 9440022129.
                    </address>
                    <p></p>
                    <p>
                    ...
                    <div class="rw-ui-container" data-urid="rate1"></div>
                    <p></p>
            </div>
        </div>
    </div>
...
<div class="container">
    <ul class="nav nav-tabs" id="myTab">
        <li class="active"><a data-toggle="tab" href="#detail1">Details</a></li>
        <li class=""><a data-toggle="tab" href="#tour1">Virtual Tour</a></li>
        <li class=""><a data-toggle="tab" href="#fac5">Facilities</a></li>
        <li class=""><a data-toggle="tab" href="#locMap5" onClick="loadLocMap('map/mapsrikrishna.php','#locMap5')">Maps</a></li>
    </ul>
    <div class="tab-content navTabBorder" id="myTabContent">
        <div id="detail1" class="tab-pane fade active in tabCont">
        ...
        <div id="tour1" class="tab-pane fade tabCont">
        ...
        <div id="fac5" class="tab-pane fade tabCont">
            <div class="row" style="padding: 10px;">
                <?php include 'locfacilities.php'; ?>
            </div>
        </div>
        
        <div id="locMap5" class="tab-pane fade tabCont">
            <div class="row" style="padding: 10px;">
