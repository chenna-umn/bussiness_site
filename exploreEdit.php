...
if (isset($_POST['id']) && !empty($_POST['id'])) 
{
    ...
    $strSQL = "SELECT * FROM explore where id=".$id;

// Execute the query (the recordset $rs contains the result)
    $rs = mysql_query($strSQL);
    $row = mysql_fetch_array($rs);
   ?>
<form method="post" enctype="multipart/form-data" action="updateExplore.php"  id="book_form" onsubmit="return validateForm()">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            ...
            <td>
        <center>
            <input type='submit' value='Update Explore' class='btn btn-primary removeBorderRadius'/>
        </center>
        </td>
        </tr>
