...
if (isset($_POST['id']) && !empty($_POST['id'])) 
{
    ...
    $strSQL = "SELECT * FROM appartment where id=".$id;

// Execute the query (the recordset $rs contains the result)
    $rs = mysql_query($strSQL);
    $row = mysql_fetch_array($rs);
   ?>
<form method="post" enctype="multipart/form-data" action="updateAppart.php"  id="book_form" onsubmit="return validateForm()">
    ...
    <table class='table table-bordered'>
        ...
        <tr>
            ...
            <td>
                <textarea id="hdesc" name="hdesc" class="inputClass" style="width:100%"><?php echo $row['hoverDescription']; ?></textarea>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
        <center>
            <input type='submit' value='Update Room' class='btn btn-primary removeBorderRadius'/>
        </center>
        </td>
        </tr>
