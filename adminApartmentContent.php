...
$strSQL = "SELECT * FROM apartmentpage";
...
<div class='container'>
    <div class='row'>
        <div class="col-sm-4">
            <div class="col-sm-12">
                <center>
                    <a href="adminApartment.php" class="btn btn-primary removeBorderRadius">
                                ...
                                <div class="">
                                    <center>
                                        ...
                                        <table class="col-sm-12 tooltip-examples">
                                            <tr>
                                                <td>
                                                    <a href="#" class="pull-left" data-toggle="tooltip" data-placement="right" title="Delete" onClick="performOperation('adminApartmentDelete.php',<?php echo $row['id']; ?>,'#clientLogoLoad');">
                                                        <span class="glyphicon glyphicon-trash"></span>
                                                    </a>  
                                                </td>
                                                <td>
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="Edit" onClick="performOperation('adminApartmentEdit.php',<?php echo $row['id']; ?>,'#addClient');">
                                                        <center>
                                                ...
                                                <td>
                                                    <a href="#" class="pull-right" data-toggle="tooltip" data-placement="left" title="Unblock" onClick="performOperation1('adminApartmentStatus.php',<?php echo $row['id']; ?>,'#clientLogoLoad',<?php echo $row['status']; ?>);">
        ...
        <div class='col-sm-8' id="addClient">
            <form method="post" enctype="multipart/form-data" action="saveApartmentPage.php"  id="book_form" onsubmit="return validateForm()">
                <table class='table table-bordered'>
                    ...
                    <tr>
                        <td colspan='2'>
                            <center>
                                <input type='submit' value='Save Apartment' class='btn btn-primary removeBorderRadius'/>
                            </center>
                        </td>
                    </tr>
