...
{  
    ...
    if(!empty($newFile))
    {
        $strSQL = "UPDATE apartmentpage set title='".$data['title']."',image='".$newFile."',description='".$data['desc']."',status=".$data['status'].",updatedOn='".time()."' where id=".$data['id'];
    }
    else
    {
        $strSQL = "UPDATE apartmentpage set title='".$data['title']."',description='".$data['desc']."',status=".$data['status'].",updatedOn='".time()."' where id=".$data['id'];
    }
//    echo $strSQL;
//    exit();
