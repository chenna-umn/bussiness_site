...
<div class='container'>
    <div class='row'>
        <div class="col-sm-4">
            <div class="col-sm-12">
                <center>
                    <a href="client.php" class="btn btn-primary removeBorderRadius">
            ...
            <div class="col-sm-12" id="clientLogoLoad">
                ...
                <div class="col-sm-6">
                            <div class="thumbnail" id='profPic1'>
                                <img class="img-responsive clientAdminMinHeight" alt="<?php echo $row['title']; ?>" src="<?php echo $row['logo']; ?>">
                                <div class="">
                                    <center>
                                        <h5>
                                            <?php echo $row['title']; ?>
                                        ...
                                        <table class="col-sm-12 tooltip-examples">
                                            <tr>
                                                <td>
                                                    <a href="#" class="pull-left" data-toggle="tooltip" data-placement="right" title="Delete" onClick="performOperation('clientDelete.php',<?php echo $row['id']; ?>,'#clientLogoLoad');">
                                                        <span class="glyphicon glyphicon-trash"></span>
                                                    </a>  
                                                </td>
                                                <td>
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="Edit" onClick="performOperation('editClient.php',<?php echo $row['id']; ?>,'#addClient');">
                                                        <center>
                                                ...
                                                <td>
                                                    <a href="#" class="pull-right" data-toggle="tooltip" data-placement="left" title="<?php echo ($row['status'] == 0) ? 'Unblock' : 'Block'; ?>" onClick="performOperation1('status.php',<?php echo $row['id']; ?>,'#clientLogoLoad',<?php echo $row['status']; ?>);">
        ...
        <div class='col-sm-8' id="addClient">
            <form method="post" enctype="multipart/form-data" action="saveLogo.php"  id="book_form" onsubmit="return validateForm()">
                <table class='table table-bordered'>
                    ...
                    <tr>
                        <td colspan='2'>
                            <center>
                                <input type='submit' value='Save Client' class='btn btn-primary removeBorderRadius'/>
                            </center>
                        </td>
                    </tr>
