...
<div class="container">
    <div class="row-fluid">
        <div class="col-sm-8">
            <center><h3 class="branch_title_color">Kunj Apartments - Hyderabad</h3></center>
        </div>
        <div class="col-sm-4">
    ...
    <div class="row-fluid">
        <div class="col-sm-8">
            <div class="thumbnail">
                <div>
                    <?php include_once 'gal/loc_Kunj.php'; ?>
                </div>
            </div>
        </div>
            ...
            <div class="tabPad">
                <p>
                    ...
                    <address>
                        ...
                        Plot no 17, Madhu Kunj apartments, Beside TDP Office, Road No 2, Banjara Hills, Hyderabad-500034
                    </address>
                    <p></p>
                    <p>
                    </p><h5>Rating</h5>
...
<div class="container">
    <ul class="nav nav-tabs" id="myTab">
        ...
        <li class=""><a data-toggle="tab" href="#locMap1" onClick="loadLocMap('map/mapkunj.php','#locMap1')">Maps</a></li>
    </ul>
