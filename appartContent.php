...
<div class='container'>
    <div class='row'>
        <div class="col-sm-4">
            <div class="col-sm-12">
                <center>
                    <a href="appart.php" class="btn btn-primary removeBorderRadius">
                                ...
                                <div class="">
                                    <center>
                                        ...
                                        <table class="col-sm-12 tooltip-examples">
                                            <tr>
                                                <td>
                                                    <a href="#" class="pull-left" data-toggle="tooltip" data-placement="right" title="Delete" onClick="performOperation('appartDelete.php',<?php echo $row['id']; ?>,'#clientLogoLoad');">
                                                        <span class="glyphicon glyphicon-trash"></span>
                                                    </a>  
                                                </td>
                                                <td>
                                                    <a href="#" data-toggle="tooltip" data-placement="top" title="Edit" onClick="performOperation('appartEdit.php',<?php echo $row['id']; ?>,'#addClient');">
                                                        <center>
                                                ...
                                                <td>
                                                    <a href="#" class="pull-right" data-toggle="tooltip" data-placement="left" title="Unblock" onClick="performOperation1('appartStatus.php',<?php echo $row['id']; ?>,'#clientLogoLoad',<?php echo $row['status']; ?>);">
        ...
        <div class='col-sm-8' id="addClient">
            <form method="post" enctype="multipart/form-data" action="saveAppart.php"  id="book_form" onsubmit="return validateForm()">
                <table class='table table-bordered'>
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea id="hdesc" name="hdesc" class="inputClass" style="width:100%"></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan='2'>
                            <center>
                                <input type='submit' value='Save Appartment' class='btn btn-primary removeBorderRadius'/>
                            </center>
                        </td>
                    </tr>
...
var editor2 = CKEDITOR.replace( 'hdesc', {
    filebrowserBrowseUrl : 'ckfinder/ckfinder.html',
    filebrowserImageBrowseUrl : 'ckfinder/ckfinder.html?type=Images',
    filebrowserFlashBrowseUrl : 'ckfinder/ckfinder.html?type=Flash',
    filebrowserUploadUrl : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
