...
if (isset($_POST['id']) && !empty($_POST['id'])) 
{
    ...
    $strSQL = "SELECT * FROM clients where id=".$id;
...
<form method="post" enctype="multipart/form-data" action="editLogo.php"  id="book_form" onsubmit="return validateForm()">
                ...
                <table class='table table-bordered'>
                    ...
                    <tr>
                        <td>
                            <img src="<?php echo $row['logo']; ?>" alt="<?php echo $row['title']; ?>" class="thumbnail img-responsive" style="width: 100px;height: 100px;"/>
                        </td>
                        <td>
                            <center>
                                <input type='submit' value='Update Client' class='btn btn-primary removeBorderRadius'/>
                            </center>
                        </td>
                    </tr>
